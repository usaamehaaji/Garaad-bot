...
module.exports = async function helpCommand(message) {
    ...
    const description =
        ...
        `🎲 **Ciyaaraha Su'aalaha** _(dhammaantood waxaa la dooran karaa tirada su'aalaha)_\n` +
        ...
        `🎮 **Ciyaaraha Kale (Other Games)**\n` +
        `\`${PREFIX}4row @user\` (ama \`${PREFIX}4inrow @user\`) - 4 Isku-xig (Connect 4) — Guulaystay +25 XP / Lumiyay −10 XP\n\n` +

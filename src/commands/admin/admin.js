...
const give      = require('./adminGive');
const take      = require('./adminTake');
    ...
    switch (sub) {
        ...
        default:
            return message.reply(
                ...
                `\`${PREFIX}admin give @user iq 10 xp 20\` — IQ/XP sii user gaar ah\n` +
                `\`${PREFIX}admin take @user iq 10 xp 20\` — IQ/XP ka jar user gaar ah\n` +
